...
const PRODUCTION_APP_URL = "https://auctionhub-xi.vercel.app/";
const DEVELOPMENT_APP_URL = "https://auctionhub-xi.vercel.app/";
...
const config = {
    ...
    APP_URL: process.env.NODE_ENV === 'production'
        ? PRODUCTION_APP_URL 
        : (process.env.NODE_ENV === 'development' ? DEVELOPMENT_APP_URL : LOCAL_APP_URL),
};
